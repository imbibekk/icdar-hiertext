...
config = OmegaConf.create({
    ...
    'pretrained_path': '/data/project/bibek/icdar/hier/oclip/outputs/hiertext/lr=0.0001_wd=0.1_agg=True_model=RN50_batchsize=32_workers=1_date=2023-03-16-01-42-12/checkpoints/epoch_100.pt'
