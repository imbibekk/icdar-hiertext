...
config = OmegaConf.create({
    ...
    'image_stds': (1., 1., 1.),
    'aug': True,
    'true_mask_erode_iter': 2,
    'true_vertices_shrink_ratio': 0,
    # postprocess
    'component_min_prob': 0.6,
    ...
    'combo_loss_coeff': 0,
    # model
    'encoder_name': 'tu-tf_efficientnetv2_l_in21ft1k', #'tu-tf_efficientnet_b7_ns', # 'tu-tf_efficientnet_l2_ns',
    # pretrained
    'checkpoint_path': None,
    'pretrained_path': '/data/project/bibek/icdar/hier/oclip/outputs/effnet_v2_hiertext/lr=0.0001_wd=0.1_agg=True_model=RN50_batchsize=32_workers=8_date=2023-03-17-21-06-25/checkpoints/epoch_100.pt',
