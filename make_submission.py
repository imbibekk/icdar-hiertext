...
if __name__ == '__main__':
    ...
    submission = batch_masks2submission(
        ...
        out['batch_image_ids'],
        out['batch_image_heights'].tolist(),
        out['batch_image_widths'].tolist(),
    ...
    #save_path = os.path.join(cfg.output_dir, f'{args.config_name}/submission/{args.dataloader_mode}.jsonl')
